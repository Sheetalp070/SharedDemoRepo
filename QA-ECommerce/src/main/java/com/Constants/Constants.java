...
/**
 * Constants class holds all the global static constant values used across the automation framework.
 * These values are primarily file paths, environment variables, and wait durations.
 */
public abstract class Constants {
	...
	// Environment variable used to determine which test data file to load ("test" or "prod")
	...
	// Path to production environment test data file (currently same as test file; can be separated if needed)
