...
/**
 * CartPage represents the shopping cart page in the e-commerce application.
 * It contains actions like updating quantity, proceeding to checkout,
 * and verifying product prices in the cart.
 */
public class CartPage extends BasePage {
	...
	/**
     * Updates the quantity of a product in the cart and clicks the "Add to Cart" button.
     * 
     * @param quantity the quantity value to be entered (should ideally be int)
     */
	public void updateQuantity(String quantity)// it should be updated as int
	{
		wait.until(ExpectedConditions.visibilityOf(quantityUpdatField));

		super.sendKeys(quantityUpdatField, "Quantity field", quantity);
	...
	/**
     * Waits for the checkout popup to disappear, then clicks on the cart icon to proceed.
     */
